...
var Widgets = require(appRoot + '/backend/modules/apps-gallery/widgets.js');
var WP = require(appRoot + '/backend/modules/apps-gallery/widgetsPlacements.js');
var Courses = require(appRoot + '/backend/modules/catalogs/courses.js');
var helper = require(appRoot + '/backend/libs/core/generalLibs.js');
var userHelper = require(appRoot + '/backend/modules/accounts/user.helper.js');
var _ = require('underscore');
var async = require('asyncawait/async');
var await = require('asyncawait/await');
var Plugin = require(appRoot + '/backend/modules/apps-gallery/backgroundPlugins.js');

function AppStore() {
    this.directory = appRoot + '/backend/modules/applications';
}
            ...
            if (err) error(err);
                ...
                var loopWidgets = async(function (docs) {
                    ...
                    for (var i in docs) {
                        ...
                        var ep = appRoot + ('/backend/modules/applications' + widg.entryPoint);
                        var OBJ = require(ep);
