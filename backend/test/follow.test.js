...
// connect to db
require(appRoot + '/backend/libs/core/database.js');

// model & logic
var Account =  require(appRoot + '/backend/modules/accounts');
var Category = require(appRoot + '/backend/modules/catalogs/categories.js');
var Course = require(appRoot + '/backend/modules/catalogs/courses.js');
var User = require(appRoot + '/backend/modules/accounts/users.js');
var UserCourse = require(appRoot + '/backend/modules/catalogs/userCourses.js');

var catalog =  require(appRoot + '/backend/modules/catalogs/category.controller.js');
