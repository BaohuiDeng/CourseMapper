...
var EnrolledUser = require(appRoot + '/backend/modules/applications/course-analytics/enrolledUserList');
var CoursePreviewStats = require(appRoot + '/backend/modules/applications/course-analytics/coursePreviewStats.controller');
var CourseHistory = require(appRoot + '/backend/modules/applications/course-analytics/course-history.controller');
var TopContent = require(appRoot + '/backend/modules/applications/top-content/top-content.controller');
var TopContributor = require(appRoot + '/backend/modules/applications/top-contributor/top-contributor.controller');

var helper = require(appRoot + '/backend/libs/core/generalLibs.js');
