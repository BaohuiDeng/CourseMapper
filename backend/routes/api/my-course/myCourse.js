...
var Course = require(appRoot + '/backend/modules/applications/my-course/myCoursesList');
var PdfStatus = require(appRoot + '/backend/modules/applications/my-course/myPDFStatus');
var VideoStatus = require(appRoot + '/backend/modules/applications/my-course/myVideoStatus.controller.js');
var TraceFinder = require(appRoot + '/backend/modules/applications/my-course/trace-finder.js');
