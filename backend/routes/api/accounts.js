...
var AccountModel = require(appRoot + '/backend/modules/accounts/users.js');
var Users = require(appRoot + '/backend/modules/accounts/users.js');
var Course = require(appRoot + '/backend/modules/catalogs/course.controller.js');
