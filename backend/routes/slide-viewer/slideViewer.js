...
var SlideViewer = require(appRoot + '/backend/modules/slide-viewer');
var SlideAnnotationZones = require(appRoot + '/backend/modules/annotationZones');
var Comment = require(appRoot + '/backend/modules/slide-viewer/index');
var AnnZones = require(appRoot + '/backend/modules/annotationZones/index');
var mongoose = require('mongoose');

var Comment = require(appRoot + '/backend/modules/slide-viewer');
